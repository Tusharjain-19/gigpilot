    ...
    <div className="card-panel p-4 relative overflow-hidden">
      <div className="flex items-center justify-between gap-3 mb-3">
        <div className="flex items-center gap-2.5">
          <div className="p-2 rounded bg-[var(--surface-low)] border border-[var(--border-color)] text-[var(--text-primary)]">
            <Trophy className="w-4 h-4 text-[#15803D] dark:text-[#79DB8D]" />
          </div>
          <div>
            <h4 className="font-heading font-semibold text-sm text-[var(--text-primary)] flex items-center gap-2">
              {mission.title}
              <span className="text-[9px] font-mono font-semibold px-1.5 py-0.5 rounded bg-[var(--surface-low)] text-[var(--text-secondary)] border border-[var(--border-color)]">
                MISSION
              </span>
            </h4>
        ...
        <div className="text-right">
          <span className="text-xs font-mono font-semibold text-[#15803D] dark:text-[#79DB8D] bg-[#15803D]/10 border border-[#15803D]/30 px-2.5 py-1 rounded block">
      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between text-xs font-medium">
          ...
          <span className="text-[#15803D] dark:text-[#79DB8D] font-mono">{percentage}%</span>
        </div>

        <div className="w-full h-1 bg-[var(--surface-low)] rounded-full overflow-hidden border border-[var(--border-color)]">
          <div
      ...
      <div className="mt-2.5 flex items-center justify-between text-[11px] text-[var(--text-muted)]">
        ...
        {mission.isCompleted && (
          <span className="text-[#15803D] dark:text-[#79DB8D] font-semibold flex items-center gap-1">
