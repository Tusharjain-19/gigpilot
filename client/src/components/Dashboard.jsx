    ...
    <div className="space-y-4 pb-20">
      ...
      <div className="card-panel p-5 relative overflow-hidden">
        ...
        <div className="flex items-baseline justify-between my-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded bg-[#15803D] hover:bg-[#166534] text-white text-xs font-semibold active:scale-95 transition-all"
          >
        ...
        {/* Stat Chips */}
        <div className="grid grid-cols-2 gap-3 pt-3 mt-3 border-t border-[var(--border-color)]">
          <div className="bg-[var(--surface-low)] rounded p-2.5 border border-[var(--border-color)] flex items-center gap-3">
            ...
            <div>
              <div className="text-[10px] font-mono font-semibold text-[var(--text-muted)] uppercase">{t.accepted}</div>
              <div className="text-sm font-heading font-semibold text-[var(--text-primary)]">{ordersAccepted} {t.orders}</div>
            </div>
          </div>
          ...
          <div className="bg-[var(--surface-low)] rounded p-2.5 border border-[var(--border-color)] flex items-center gap-3">
            ...
            <div>
              <div className="text-[10px] font-mono font-semibold text-[var(--text-muted)] uppercase">{t.rejected}</div>
              <div className="text-sm font-heading font-semibold text-[var(--text-primary)]">{ordersRejected} {t.orders}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div className="flex items-center gap-3">
          <div className="p-2 rounded bg-[var(--surface-low)] text-[var(--text-primary)] border border-[var(--border-color)]">
            <ArrowUpRight className="w-4 h-4 text-[#15803D] dark:text-[#79DB8D]" />
          </div>
          <div>
            <h4 className="font-heading font-semibold text-sm text-[var(--text-primary)]">
              {t.viewRadar}
            </h4>
            <p className="text-xs text-[var(--text-muted)]">{t.surgeActive} • {t.estRate}</p>
          </div>
        </div>
        <span className="text-xs font-mono font-semibold text-[#15803D] dark:text-[#79DB8D] bg-[#15803D]/10 px-3 py-1.5 rounded border border-[#15803D]/30">
          {t.openRadar}
        </span>
      </div>
